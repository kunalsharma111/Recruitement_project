...
<body bgcolor="#EEEEEE">
      <div class="wrapper">
            ...
            <div class="content" style="z-index: 0;">
                ...
                String find2=(String)request.getAttribute("find2");
                
                if(((find1 != null && !find1.isEmpty())||(find2!=null && !find2.isEmpty())) && records!=null)
                {for(job j: records){
                if(find1.equalsIgnoreCase(j.getJob_name()) ||find2.equalsIgnoreCase(j.getJob_location())){
